...
describe('UsersService', () => {
  ...
  describe('findOne', () => {
    it('should return a entity not found error', async () => {
      await expect(userService.findOne(5))
        .rejects
  ...
  describe('create', () => {
    ...
    describe('create', () => {
      it('should return a query failed error', async () => {
        await expect(userService.create(createUserDto2))
          .rejects
  ...
  describe('update', () => {
    ...
    it('should return the new user', async () => {
      expect(await userService.update(1, updateUserDto)).toBe(database.users[0]);
    })
    ...
    it('should return a entity not found error', async () => {
      await expect(userService.update(1, updateUserDto2))
        .rejects
        .toThrowError(EntityNotFoundError);
    });
  ...
  describe('remove', () => {
    ...
    it('should return a entity not found error', async () => {
      await expect(userService.remove(5))
        .rejects
        .toThrowError(EntityNotFoundError);
    });
  })
